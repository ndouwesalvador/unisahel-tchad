...
export const Meteors = ({
  ...
  useEffect(() => {
    ...
    // Must stay in an effect: this reads `window.innerWidth` and `Math.random()`,
    // both unavailable/non-deterministic during SSR — computing it during render
    // (e.g. via useMemo) would crash on the server or cause a hydration mismatch.
